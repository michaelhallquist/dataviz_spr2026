...
1. Build the plot in layers rather than writing one giant line of code from scratch.
2. Include the code you used and the resulting plot.
3. When a question asks for interpretation, write 1-3 sentences.

Unless a prompt tells you otherwise, use this workflow:

1. Start with `p <- ggplot(...)`.
2. Add or revise layers one step at a time.
3. End with readable labels and a clean theme.
...
2. Build the plot object in layers.
