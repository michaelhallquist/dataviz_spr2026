...
- Wilson, G., Aruliah, D. A., Brown, C. T., Chue Hong, N. P., Davis, M., Guy, R. T., Haddock, S. H. D., Huff, K. D., Mitchell, I. M., Plumbley, M. D., Waugh, B., White, E. P., & Wilson, P. (2014). [Best Practices for Scientific Computing](https://ares.lib.unc.edu/ares/ares.dll?SessionID=J121123599M&Action=10&Type=10&Value=109356815). *PLoS Biology, 12*(1), e1001745. https://doi.org/10.1371/journal.pbio.1001745
- Karl Broman steps to reproducible research: <http://kbroman.org/steps2rr/>

### Practical readings

- Gandrud (2015). [Chs. 2 and 4 in *Reproducible Research with R and RStudio.*](https://ares.lib.unc.edu/ares/ares.dll?SessionID=W122925617H&Action=10&Type=10&Value=109356818)
