...
- Wickham, *ggplot2* (3rd edition).
  ...
  - Building a plot layer by layer: <https://ggplot2-book.org/layers.html>
...
- Heer, J., Bostock, M., & Ogievetsky, V. (2010). [A Tour through the Visualization Zoo.](https://idl.uw.edu/papers/visualization-zoo) *Communications of the ACM*, *53*(6), 59-67.

### Practical readings

- Wickham, *ggplot2* (3rd edition; online draft).
  - (Remapped from 2nd edition Chs. 2 and 3)
  ...
  - Ch. 5: Statistical summaries. https://ggplot2-book.org/statistical-summaries.html
